...
//Retrieve the id, firstname, lastname, for the username/password combination
...
//run the query and assign it to the variable
    ...
    if (@mysqli_num_rows ($result) == 1) {
        ...
        echo '<p class = "error"> The username and password entered do notmatch our records 
...
<p><label class ="lable" for ="Password"> Password: </label>
